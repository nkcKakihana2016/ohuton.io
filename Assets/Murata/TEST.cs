...
public class TEST : MonoBehaviour {
    ...
    private void Start()
    {
        ...
        for (int i = 0; i < 264; i++)
        {
            ...
            GameObject futon = Instantiate(m_Futon) as GameObject;
            futon.transform.position = new Vector3(Random.Range(-10f,10f)+m_FutonSizeX, 0, Random.Range(-17.5f,17.5f)+m_FutonSizeZ);
        }
        //布団の設置開始
